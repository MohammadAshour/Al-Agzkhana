        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg text-red-600 font-semibold border border-red-100 hover:bg-red-50 hover:border-red-200 transition-all duration-200 shadow-sm"
            >
              <svg 
